...
const PACKAGES = {
  none: {
    label: 'No Mic Selected',
    mics: []
  },
  boom_lav: {
    label: 'Boom + Lav Dialogue',
    mics: ['mkh416', 'cos11d']
  },
  exterior_quiet: {
    label: 'Quiet Exterior Dialogue',
    mics: ['cmit', 'dpa4060', 'cos11d']
  },
  lav_heavy: {
    label: 'Lav Heavy / Wardrobe',
    mics: ['cos11d', 'dpa4060', 'dpa6060', 'b6']
  },
  boom_only: {
    label: 'Boom Only',
    mics: ['mkh416', 'cmit']
  ...
  interior: {
    label: 'Interior / Controlled',
    mics: ['mkh50', 'mk41']
  },
  custom: {
    label: 'Specific Mic Override',
    mics: []
  }
};
